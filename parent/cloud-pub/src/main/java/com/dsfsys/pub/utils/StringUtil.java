...
public class StringUtil extends StringUtils {
	 ...
	 * @return
	 */
	public static String fillStrToHead(String str,String val,int numbs) {
	 ...
	 * @return
	 */
	public static String fillStrToEnd(String str,String val,int numbs) {
	 ...
	 * set转String
	 *
	 * @param ruleIdsSet set集合
	 * @return String
	 */
	public static String getStringBySet(Set<String> ruleIdsSet) {
		String ruleIdStr = "";
		if (ruleIdsSet == null) {
			return ruleIdStr;
		}
		for (String s : ruleIdsSet) {
			ruleIdStr += "'" + s + "',";
		}
		if (ruleIdStr.length() > 0) {
			ruleIdStr = ruleIdStr.substring(0, ruleIdStr.length() - 1);
		}
		return ruleIdStr;
	}
	 ...
	 * @return
	 */
	public static String numberFormat(String pattern,Object value){
...
//        System.out.println(mulite("1234.345", "29.01234"));
		System.out.println(numberFormat("0000",123));
	}
